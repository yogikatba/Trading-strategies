...
import './App.css';
      ...
      class Bear_spread_using_put extends React.Component {
  constructor(props){
    super(props);
    this.state = {
      option: 'put',
  ...
  render() {
    return (
        ...
        <h1>Bear Spread using put option</h1>
      
        
        <div className="infoitem">
        <ul>
        <li>
         an investor who enters into a bear spread is hoping that the stock price will decline.</li>
        
        <li>investor is using put options to form bear spread.</li>
        
        <li>The investor buys a put with a high strike price and sells a put with a low strike price.</li>
        
        <li>Lets suppose that we will buy the put option at strike price K2 which is higher than the strike price K1.We will sell put option at strike price K1.</li>
        
        <li>So when the strike price will be less than K1 both of the option will be executed so total payoff will be K2-K1.</li>
         
        <li>when the strike price will be in between K1 and K2 ,option option with K2 will be executed but K1 will not we executed.</li>
...
export default Bear_spread_using_put