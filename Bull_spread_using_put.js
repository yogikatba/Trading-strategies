...
import './App.css';
      ...
      class Bull_spread_using_put extends React.Component {
  constructor(props){
    super(props);
    this.state = {
      option: 'put',
  ...
  render() {
    return (
        ...
        <h1>Bull Spread using put</h1>
      
        
        <div className="infoitem">
        <ul>
        <li>
         an investor who enters into a bear spread is hoping that the stock price will increase.</li>
        
        <li>investor is using put options to form bull spread.</li>
        
        <li>The investor buys a put with a low strike price and sells a put with a high strike price.</li>
        
        <li>Lets suppose that we will buy the put option at strike price K1 which is higher than the strike price K1.We will put call option at strike price K2.</li>
        
        <li>So when the strike price will be less than K1 none of the option will executed .</li>
        
        <li>when the strike price will be in between K1 and K2 ,put option with K1 strike price will be executed but K2 will not we executed.</li>
...
export default Bull_spread_using_put